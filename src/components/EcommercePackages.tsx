...
import { ECOMMERCE_PACKAGES, PricingPackage } from '../data/pricingData';

interface EcommercePackagesProps {
  selectedId: string | null;
  onSelect: (pkg: PricingPackage) => void;
}

export const EcommercePackages: React.FC<EcommercePackagesProps> = ({ selectedId, onSelect }) => {
  return (
    <div className="space-y-8">
      <div className="text-left">
        ...
        <p className="text-slate-500 mt-2 text-sm sm:text-base">
          Ready to sell online? Select an optimized digital store package designed for high performance.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {ECOMMERCE_PACKAGES.map((pkg) => {
          ...
          const isFeatured = pkg.id === 'eco_standard'; // "Most Popular" is featured
          ...
          return (
            ...
            >
              ...
              <div className="p-6 pt-0">
                ...
                >
                  {isSelected ? 'Selected E-Commerce' : 'Select E-Commerce'}
                </button>
              </div>
            </div>
          );
